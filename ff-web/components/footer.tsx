export const Footer = () => {
  return (
    <div className="flex flex-grow rounded border border-double border-gray-100 bg-cobalt-blue bg-cover bg-blend-multiply border-b-2 py-[6vh] text-gray-100 text-lg ">
