...
export const ResumeBody = () => {
  return (
    <div className="bg-slate-200 rounded-lg shadow-lg px-8 py-6 md:py-8 mx-auto w-full md:w-3/4">
      ...
      <div className="mb-4">
        ...
        <div>
          ...
          <ul className="list-disc pl-6">
            ...
            <li>
              Used Typescript and Tailwind CSS to help design a branded website
            </li>
      ...
      <div className="mb-4">
        ...
        <div className="grid grid-cols-2 gap-4 mt-2">
          ...
          <div>
            ...
            <p className="text-gray-600">
              Agile Methodologies, Google Design Sprints, Kanban, Scrum, GitHub,
              Figma, Notion
            </p>
          </div>
          <div>
      ...
      <div>
        ...
        <ul className="list-disc pl-6">
          <li>
            Technology Entrepreneurship: Lean startup model, market and industry
